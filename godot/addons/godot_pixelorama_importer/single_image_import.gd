...
func get_import_options(preset):
	return [
		{"name": "detect_3d", "default_value": false},
		{"name": "flags/repeat", "property_hint": PROPERTY_HINT_ENUM, "hint_string": "Disabled,Enabled,Mirrored", "default_value": 0},
		{"name": "flags/srgb", "property_hint": PROPERTY_HINT_ENUM, "hint_string": "Disable,Enable,Detect", "default_value": 2}
	]
